...
class gnomAD:
    def __init__(self,
        ...
        :param namedexfile: path to json generated by ``UniprotReader`` which all the gene synomyms to Uniprot id.
        :type namedexfile: str
        :param folder: Where to save. Internally this is ``self.outfolder``.
        :type folder: str
    ...
    def write(self):
        ...
        for gene in self.data:
            with open(os.path.join(self.outfolder, gene+'.json'),'w') as w:
